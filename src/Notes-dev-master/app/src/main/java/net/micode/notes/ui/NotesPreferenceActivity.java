...
public class NotesPreferenceActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .replace(android.R.id.content, new NotesPreferenceFragment())
                .commit();
    ...
    private void loadAccountPreference() {
        mAccountCategory.removeAll(); // 清空所有条目
        ...
        // 使用 Lambda 表达式简化 OnPreferenceClickListener
        ...
        mAccountCategory.addPreference(accountPref); // 将账户偏好项添加到分类中
    }
