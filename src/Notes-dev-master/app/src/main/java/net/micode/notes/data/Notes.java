...
public class Notes {
    ...
    public static final int TYPE_TRASH = 1;  // 添加回收站类型常量
    ...
    public static final long ID_TRASH_FOLER = -1;  // 回收站文件夹的ID
    ...
    public static final String INTENT_EXTRA_NOTE_ID = "note_id";  // 添加便签ID的Intent额外数据键
    public static final String INTENT_EXTRA_FROM_TRASH = "from_trash";
